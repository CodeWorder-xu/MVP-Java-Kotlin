...
import com.xhf.wholeproject.utils.PaintInfoUtil;
...
public class SettingPopup extends BasePopupWindow implements View.OnClickListener, SeekBar.OnSeekBarChangeListener {
    ...
    protected View createConvertView() {
        return LayoutInflater.from(mContext)
                .inflate(R.layout.popup_setting, null);
    }
    ...
    private void initEvents() {
        ...
        mTheme = SaveUtils.getInt(mContext, SaveUtils.THEME);
        mFlipStyle = SaveUtils.getInt(mContext, SaveUtils.FLIP_STYLE);
        ...
        mSwitchView.setOnCheckedChangeListener(new SwitchView.OnCheckedChangeListener() {
            ...
            public void onCheckedChange(boolean isChecked, View view) {
                ...
                if (isChecked) {
                    ScreenBrightnessUtil.openAutoBrightness(mContext);
                    setBrightness(ScreenBrightnessUtil.getBrightness(mContext));
                } else {
                    ScreenBrightnessUtil.setAutoBrightness(false);
                }
            }
        });
    ...
    private void initViews() {
        ...
        //初始化亮度进度条
        int brightness = ScreenBrightnessUtil.getBrightness(mContext);
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        ...
        if (seekBar.getId() == R.id.brightness_seek_bar) {
            ...
            ScreenBrightnessUtil.setBrightness(mContext, progress);
