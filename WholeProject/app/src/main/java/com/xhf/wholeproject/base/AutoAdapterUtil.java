 ...
 *author:Xu.Mr
 *
 *content:来自今日头条的屏幕适配方案
 */
public class AutoAdapterUtil {
    ...
    private static final float DEFAULT_WIDTH = 1440f; //默认宽度 720dp
    private static final float DEFAULT_HEIGHT = 3200f; //默认高度   1080dp
